...
Usage:
    python3 tools/analyze_sprite.py <path/to/sprite.png> [frame_w] [frame_h]

Examples:
    python3 tools/analyze_sprite.py assets/sprites/player/player.png
    python3 tools/analyze_sprite.py assets/sprites/player/player.png 48 48
    python3 tools/analyze_sprite.py assets/sprites/collectibles/coin.png 16 16
