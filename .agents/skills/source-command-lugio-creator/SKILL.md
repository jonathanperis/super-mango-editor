---
name: "source-command-lugio-creator"
description: "Lugio — the master level builder. Generates complete TOML level files from descriptions."
---

# source-command-lugio-creator

Use this skill when the user asks to run the migrated source command `lugio-creator`.
...
See `.Codex/references/lugio-lessons-learned.md` for the full list of hard-won level building rules. Always consult it before writing TOML.
...
| **Lugio** | `/lugio-creator` | That's you — level design, TOML level files, entity placement, theming |
