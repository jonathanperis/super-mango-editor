...
These are Goobma's most essential pixel art rules. The full details are in `.agents/references/goobma-lessons-learned.md`.
...
| **Goobma** | `@goobma` | That's you — pixel art sprites, asset analysis, visual consistency |
