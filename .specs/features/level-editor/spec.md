...
| D-005 | CI quality gates | Native game/editor builds, 11-test suite, TOML validation, game/editor smoke, WebAssembly artifact smoke, and docs lint/build are CI-gated. |
...
`make test` currently runs 11 regression binaries, including serializer, level validation, runtime load, rail, entity-utils, collision, phase-transition, exporter, editor-validation, gameplay-damage, and gameplay-config tests.
