...
Visual level editor — standalone C/SDL2 application. Primary validation: **recreate level_01.c (Sandbox) pixel-perfectly**.
...
| 6 — Polish | T-018 to T-020 | Toolbar, level_01.json seed, rail/gap tools |
