...
Super Mango is an intentionally minimal, heavily-commented game project designed as a **learning resource** for C + SDL2 game development. The player runs, jumps, and climbs through a multi-layer parallax mountain stage with one-way platforms, floating platforms (static/crumble/rail), crumble bridges, sea gaps, collectible coins, yellow stars, a last star goal, climbable vines, ladders, and ropes, animated water, nine enemy/hazard types (spiders, jumping spiders, birds, faster birds, fish, faster fish, rail-riding spike blocks, spike rows, spike platforms), five trap types (circular saws, axe traps, blue flames, spike blocks, spike platforms), three bouncepad variants (small, medium, high), spring-loaded bouncepads, and atmospheric fog, with smooth delta-time physics, a scrolling camera, sprite sheet animation, a start menu, an HUD with hearts and score, a sandbox mode, and an optional debug overlay.
