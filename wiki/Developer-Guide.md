...
6.  Bouncepads        (Bouncepad_Wood.png spring pads on floor/platforms)
7.  Rails             (Rails.png bitmask tile tracks)
8.  Vines             (Vine.png climbable plants hanging from platforms)
9.  Coins             (Coin.png collectibles on top of platforms)
10. Fish              (Fish_2.png jumping water enemies, before water for submerged look)
11. Water             (Water.png animated scrolling strip)
12. Spike blocks      (Spike_Block.png rotating rail-riding hazards)
13. Spiders           (Spider_1.png ground patrol enemies)
14. Jumping spiders   (Spider_2.png jumping patrol enemies)
15. Birds             (Bird_2.png slow sine-wave sky patrol)
16. Faster birds      (Bird_1.png fast aggressive sky patrol)
17. Player            (Player.png animated sprite)
18. Fog / Overlays    (Sky_Background sliding layers)
19. HUD / UI          (hud_render: hearts, lives, score — always on top)
20. Debug overlay     (debug_render: FPS, collision boxes, event log — when --debug)
```
