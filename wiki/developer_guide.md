...
Always draw in painter's algorithm order (back to front). The game currently uses 30 layers:
...
```
 ...
 6. Bouncepads             (bouncepad_small/medium/high.png spring pads)
 7. Rails                  (rail.png bitmask tile tracks)
 8. Ladders                (ladder.png climbable)
 9. Ropes                  (rope.png climbable)
10. Vines                  (vine.png climbable)
11. Yellow stars           (yellow_star.png health pickups)
12. Coins                  (coin.png collectibles)
13. Blue flames            (blue_flame.png erupting from sea gaps)
14. Fish                   (fish.png jumping water enemies)
15. Faster fish            (faster_fish.png fast jumping enemies)
16. Water                  (water.png animated strip)
17. Spike blocks           (spike_block.png rail-riding hazards)
18. Spikes                 (spike.png ground hazards)
19. Spike platforms        (spike_platform.png elevated hazards)
20. Axe traps              (axe_trap.png swinging hazards)
21. Circular saws          (circular_saw.png patrol hazards)
22. Spiders                (spider.png ground patrol)
23. Jumping spiders        (jumping_spider.png jumping patrol)
24. Birds                  (bird.png slow sine-wave)
25. Faster birds           (faster_bird.png fast sine-wave)
26. Player                 (player.png animated)
27. Last star              (last_star.png end-of-level)
28. Fog                    (fog_background_1/2.png sliding overlay)
29. HUD                    (hearts, lives, score -- always on top)
30. Debug overlay          (FPS, hitboxes, event log -- when --debug)
```
